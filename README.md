...
> [!NOTE]
> NightScope is a released application. Source version 1.46.3 is prepared for
...
- Includes an offline celestial catalogue with 7,585 distinct deep-sky
  ...
  are explicitly marked as work in progress. A first 17-object remediation
  pass also replaces a generic historical galaxy-note family with specific,
  source-backed observing guidance in all three languages. Per-target Home eligibility is
...
`dist/NightScope-v1.46.3-debian-12-x64.tar.gz` and its adjacent `.sha256`
