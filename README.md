...
- Sky Compass prototipale per indicare la direzione ampia migliore in base ai target Home già disponibili; non è un planetario e non sostituisce la mappa cielo.
...
Versione stabile di riferimento: `1.1.5`.
