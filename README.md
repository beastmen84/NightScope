...
> Windows 1.47.0 and Linux 1.43.0. Source version 1.47.0 adds practical observing
> windows, annual IMO meteor calendars, guarded short-term COBS comet guidance,
> and database-startup improvements, available in the Windows release published
> on 2026-09-20. Features added after 1.43.0 are not yet in the
...
- Windows: [NightScope 1.47.0](https://github.com/beastmen84/NightScope/releases/tag/v1.47.0),
  published as a portable [Windows x64 ZIP](https://github.com/beastmen84/NightScope/releases/download/v1.47.0/NightScope-v1.47.0-windows-x64.zip).
...
The `v1.47.0` release contains only the Windows package and points to source
tag `v1.47.0`. Linux downloads remain on `v1.43.0`; consult each release for
...
`1.47.0` and Linux `1.43.0`. Windows 1.47.0 was published on 2026-09-20;
its source tag and uploaded ZIP metadata are recorded in `docs/TESTING.md`.
