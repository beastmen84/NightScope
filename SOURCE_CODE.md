...
This file accompanies the NightScope 1.46.20 development source. Its intended
release tag is `v1.46.20`, not yet created or published. The planned source URL
`https://github.com/beastmen84/NightScope/tree/v1.46.20` must be verified before
