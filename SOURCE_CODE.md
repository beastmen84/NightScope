...
This file accompanies the NightScope 1.46.18 development source. Its intended
release tag is `v1.46.18`, not yet created or published. The planned source URL
`https://github.com/beastmen84/NightScope/tree/v1.46.18` must be verified before
