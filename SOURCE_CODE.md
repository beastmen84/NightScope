...
This file is prepared for the NightScope 1.45.20 portable release bundles.

## NightScope

NightScope is distributed under the Mozilla Public License 2.0. The complete
corresponding source for these bundles is identified by the `v1.45.20` tag:

- Repository: `https://github.com/beastmen84/NightScope`
- Release source: `https://github.com/beastmen84/NightScope/tree/v1.45.20`
- Source archive:
  `https://github.com/beastmen84/NightScope/archive/refs/tags/v1.45.20.tar.gz`
...
NightScope 1.45.20 uses unmodified PySide6/shiboken6 6.11.2 and Qt 6.11.2 under
