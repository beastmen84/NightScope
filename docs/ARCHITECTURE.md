...
This document describes the architecture implemented by the NightScope 1.46.6
...
- `ObjectDescription` and `ObjectCuriosity` retain complete reviewed
  ...
  Sources `1.46.3` through `1.46.6` additionally record field-scoped
  remediation of 126 baseline galaxy, open-cluster, globular-cluster, and
  nebula entries without changing catalogue coverage.
