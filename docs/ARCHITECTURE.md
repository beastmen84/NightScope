...
This document describes the architecture implemented by the NightScope 1.46.3
...
- `ObjectDescription` and `ObjectCuriosity` retain complete reviewed
  ...
  Source `1.46.3` additionally records field-scoped remediation of 17 baseline
  galaxy entries without changing catalogue coverage.
