...
The `1.46.5` Windows/Python 3.14.5 baseline was validated with pip 26.2.1,
...
enrichment manifests, three baseline-remediation manifests covering 106 objects,
...
baseline objects and 10 observing-note families across 71 objects, so identity
...
The `1.46.5` coverage/security source gate passed on Windows/Python 3.14.5 with
1,227 tests and 10 subtests in 269.79 seconds, 86% aggregate application
