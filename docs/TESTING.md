...
The `1.45.17` Windows/Python 3.14.5 baseline was validated with pip 26.2.1,
...
The `1.45.17` coverage/security source gate passed on Windows/Python 3.14.5 with
1,172 tests and 10 subtests in 330.30 seconds, 86% aggregate application
coverage, no unexpected warning summary, complete documentation coverage for
241 Python, 34 QML, and 15 operational files, an acyclic production graph, zero
