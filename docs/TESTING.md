...
| Photographic optical-train foundation | 10 focused tests cover both camera adapters, all 77 seeded cameras, prime focus, exact imaging-reducer links, Barlows, sensor geometry, pixel scale, field of view, backfocus and stable deduplication; the foundation has no direct controller or QML registration |
