...
Measured on the current Windows development environment for `1.24.1`:

| Command | Result | Time |
| --- | --- | ---: |
| `python -m pytest -q -n auto` | `668 passed, 7 subtests passed` | `0:00:54` |
...
reduction in `1.21.0` was intentional: migration-only
