...
## Measured Unreleased Camera, Profile And Imaging Backend Gate
...
| Complete deterministic suite | 1,005 passed, 643 known Skyfield/NumPy warnings, 10 subtests passed in 289.41 s |
