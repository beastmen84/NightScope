...
data and practical advice distinct. Messier
...
`short_description` and `observing_notes`; new prose is not duplicated into the
historic catalogue `descrizione` field.
