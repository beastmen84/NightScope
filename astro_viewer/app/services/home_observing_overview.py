...
def _location_context_payload(*, pending: bool) -> dict[str, object]:
    ...
    session = {
        ...
        "title": tr("Sessione non valutabile"),
        "badge": tr("Non disponibile"),
        "detail": tr("Posizione necessaria per valutare la sessione."),
        "description": tr("Configura una posizione per ottenere le condizioni locali."),
        "windowLabel": "",
        "windowValue": "",
        "windowText": tr("Finestra non disponibile"),
        "hasWindow": False,
        "limitingFactorCode": "no_location",
        "limitingFactor": tr("Posizione non disponibile"),
    }
    return {
        "schemaVersion": HOME_OBSERVING_OVERVIEW_SCHEMA_VERSION,
        "session": session,
        "weather": {
            ...
            "scoreValue": None,
            "scoreLabel": tr("n/d"),
            "explanation": tr("Posizione necessaria per il meteo."),
            "windowText": session["windowText"],
        },
        "planetary": {
            "state": "unavailable",
            ...
            "secondaryMetric": tr("Posizione necessaria"),
            "hint": tr("Configura una posizione"),
            "source": "no_location",
        },
        "deepSky": {
            "state": "unavailable",
        ...
        "moon": {
            "impact": "unavailable",
            "impactLabel": tr("Impatto lunare non disponibile"),
            "summary": tr("Posizione necessaria per la Luna."),
        },
    }
