...
class Phase6RealDataTests(unittest.TestCase):
    ...
    def test_sidebar_navigation_groups_configuration_and_catalogs(self) -> None:
        ...
        self.assertIn('catalogue: "astronomyCameraCatalog"', cameras_qml)
        self.assertIn('catalogue: "cameraBodyCatalog"', cameras_qml)
        self.assertIn("astronomyCameraSnapshot.items.filter", cameras_qml)
        self.assertIn("cameraBodySnapshot.items.filter", cameras_qml)
        ...
        self.assertIn("controller.requestCatalogueMonth(requestedMonth)", object_catalogue_qml)
        self.assertIn("!controller.catalogueMonthRefreshActive", object_catalogue_qml)
        ...
        self.assertIn('catalogue: "binocularCatalog"', binoculars_qml)
        self.assertIn("binocularSnapshot.items.filter", binoculars_qml)
        ...
        self.assertIn('catalogue: "filterCatalog"', filters_reducers_qml)
        self.assertIn('catalogue: "reducerCatalog"', filters_reducers_qml)
        self.assertIn("filterSnapshot.items.filter", filters_reducers_qml)
        self.assertIn("reducerSnapshot.items.filter", filters_reducers_qml)
    ...
    def test_select_solar_system_catalogue_object_opens_catalogue_detail(self) -> None:
        with _controller() as controller:
            ...
            self.assertTrue(selected["catalogueVisibleCurrentMonth"])
            self.assertEqual(selected["catalogueVisibleCurrentMonthLabel"], "Sì")
