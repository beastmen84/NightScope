...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            _moon(10),
            [
                ("galaxy", 36, "21:00 sera"),
                ("cluster", 40, "22:00 sera"),
                ("planet", 37, "23:00 sera"),
                ("nebula", 34, "00:30 notte"),
            ],
        ),
        (
            "high_bortle",
            ...
            _moon(10),
            [
                ("galaxy", 26, "21:00 sera"),
                ("cluster", 36, "22:00 sera"),
                ("planet", 37, "23:00 sera"),
                ("nebula", 25, "00:30 notte"),
            ],
        ),
        (
            ...
            _moon(95),
            [
                ("galaxy", 23, "21:00 sera"),
                ("cluster", 36, "22:00 sera"),
                ("planet", 37, "23:00 sera"),
                ("nebula", 23, "00:30 notte"),
            ],
        ),
        (
            "poor_weather_score",
        ...
        (
            ...
            _moon(10),
            [
                ("galaxy", 39, "21:00 sera"),
                ("cluster", 43, "22:00 sera"),
                ("planet", 41, "23:00 sera"),
                ("nebula", 36, "00:30 notte"),
            ],
        ),
        (
            ...
            [
                ...
                ("cluster", 20, "22:00 sera"),
                ("planet", 20, "23:00 sera"),
                ("nebula", 17, "00:30 notte"),
            ],
        ),
    ],
)
