...
class ReleaseScenarioTests(unittest.TestCase):
    ...
    def test_calendar_event_cards_open_inline_detail_view(self) -> None:
        ...
        self.assertIn("Layout.columnSpan: scroll.availableWidth >= 1160 ? 2 : 1", detail_qml)
    ...
    def test_data_providers_page_exposes_earthdata_configuration(self) -> None:
        ...
        self.assertIn("columns: earthdataCard.width >= 620 ? 2 : 1", qml)
        self.assertNotIn("columns: earthdataCard.width >= 720 ? 2 : 1", qml)
