...
class ReleaseScenarioTests(unittest.TestCase):
    ...
    def test_weather_page_displays_active_location_context(self) -> None:
        ...
        self.assertIn('title: "Trasparenza atmosferica"', qml)
        ...
        self.assertIn('MetricTile { label: "Trasparenza"', qml)
        self.assertIn('MetricTile { label: "Misura"', qml)
    ...
    def test_calendar_event_cards_open_inline_detail_view(self) -> None:
        ...
        self.assertIn("È la notte in cui il pianeta merita davvero", detail_qml)
        self.assertIn("È la finestra con meno luce lunare", detail_qml)
        self.assertIn("Il terminatore attraversa zone ricche di rilievi", detail_qml)
        self.assertIn("Il telescopio non serve", detail_qml)
        self.assertIn("l'intero disco lunare deve restare nel campo", detail_qml)
        self.assertIn("Osserva il Sole solo con filtri solari certificati", detail_qml)
        self.assertIn("È interessante quando puoi inquadrare", detail_qml)
